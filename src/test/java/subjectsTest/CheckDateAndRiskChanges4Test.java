...
public class CheckDateAndRiskChanges4Test extends AbstractParentTest {
    ...
    public void preconditions() {
        ...
        if (methodName.equals("to_2_checkDateOfLastInspANDriskSt_CA_4_Test")) {
    ...
    @Test
    public void to_1_changeDateOfLastInspANDriskSt_TRO_4_Test() throws InterruptedException {
    ...
    @Test
    public void to_2_checkDateOfLastInspANDriskSt_CA_4_Test() throws InterruptedException {
        mainPage.mainMenu.clickOnDovidnyky();
        mainPage.mainMenu.clickOnSubyektyGosp();
        subjectsListPage.clickOnSphereField();
        subjectsListPage.clickOnSphereAutoTranspItem();
        ...
        /*
        Блок кода не доступен для пользователя officialPersonCA

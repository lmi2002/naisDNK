...
public class SearchResultTrainingMaterialsPage extends ParentPage {
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), configProperties.base_url() + "/training-material/index?TrainingMaterialSearch%5Bname%5D=НКМ&TrainingMaterialSearch%5Bregulator_id%5D=&TrainingMaterialSearch%5Bsphere_id%5D=&TrainingMaterialSearch%5Bupdated_at%5D=");
    }

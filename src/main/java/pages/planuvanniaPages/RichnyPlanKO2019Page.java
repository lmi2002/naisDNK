...
public class RichnyPlanKO2019Page extends ParentPage {

    public RichnyPlanKO2019Page (WebDriver webDriver) {
        super(webDriver, "/plan-inspection/index?planning_period_id=2&regulator_id=61");
    }
    ...
    @FindBy(xpath = ".//a[@class='nav-link active' and contains(text(),'Актуальні перевірки')]")

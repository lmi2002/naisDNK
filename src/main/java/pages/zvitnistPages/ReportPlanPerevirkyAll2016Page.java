...
public class ReportPlanPerevirkyAll2016Page extends ParentPage {

    public ReportPlanPerevirkyAll2016Page(WebDriver webDriver) {
        super(webDriver, "/report/planned?regulator_id=61&planning_period_id=5");
    }

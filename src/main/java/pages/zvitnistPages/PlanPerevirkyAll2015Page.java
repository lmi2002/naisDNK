...
public class PlanPerevirkyAll2015Page extends ParentPage {

    public PlanPerevirkyAll2015Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-general?regulator_id=61&planning_period_id=7");
    }
    ...
    @FindBy(xpath = ".//a[@href='/report/plan-violations?regulator_id=61&planning_period_id=7']")
    private WebElement planPerevirkyPorushenniaLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-general?regulator_id=61&planning_period_id=7']")
    private WebElement pozaplanPerevirkyAllLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-violations?regulator_id=61&planning_period_id=7']")

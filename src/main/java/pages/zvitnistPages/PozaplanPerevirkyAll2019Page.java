...
public class PozaplanPerevirkyAll2019Page extends ParentPage {

    public PozaplanPerevirkyAll2019Page(WebDriver webDriver) {
        super(webDriver, "/report/unplanned-general?regulator_id=61&planning_period_id=2");
    }

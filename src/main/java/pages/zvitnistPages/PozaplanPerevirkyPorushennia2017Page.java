...
public class PozaplanPerevirkyPorushennia2017Page extends ParentPage {

    public PozaplanPerevirkyPorushennia2017Page(WebDriver webDriver) {
        super(webDriver, "/report/unplanned-violations?regulator_id=61&planning_period_id=3");
    }

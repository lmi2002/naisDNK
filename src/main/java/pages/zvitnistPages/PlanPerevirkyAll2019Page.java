...
public class PlanPerevirkyAll2019Page extends ParentPage {

    public PlanPerevirkyAll2019Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-general?regulator_id=34&planning_period_id=2");
    }
    ...
    @FindBy(xpath = ".//a[@href='/report/plan-violations?regulator_id=34&planning_period_id=2']")
    private WebElement planPerevirkyPorushenniaLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-general?regulator_id=34&planning_period_id=2']")
    private WebElement pozaplanPerevirkyAllLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-violations?regulator_id=34&planning_period_id=2']")

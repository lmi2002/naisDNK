...
public class ZvitPoZahodahKOza2018Page extends ParentPage {
    public ZvitPoZahodahKOza2018Page(WebDriver webDriver) {
        super(webDriver, "/report/activity?year=2018&regulator_id=103");
    }

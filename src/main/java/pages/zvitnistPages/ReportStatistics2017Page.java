...
public class ReportStatistics2017Page extends ParentPage {

    public ReportStatistics2017Page(WebDriver webDriver) {

        super(webDriver, "/regulator/statistics?planning_period_id=3");
    }

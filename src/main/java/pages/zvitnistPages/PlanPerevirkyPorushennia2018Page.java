...
public class PlanPerevirkyPorushennia2018Page extends ParentPage {

    public PlanPerevirkyPorushennia2018Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-violations?regulator_id=61&planning_period_id=1");
    }

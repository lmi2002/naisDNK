...
public class ZvitProPorushenniaVymogKO2020Page extends ParentPage {

    public ZvitProPorushenniaVymogKO2020Page(WebDriver webDriver) {
        super(webDriver, "/report/violation-of-requirements?year=2020&regulator_id=103&sphere_id=130");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/report/violation-of-requirements?year=2020&regulator_id=103&sphere_id=130");
    }

...
public class PlanPerevirkyPorushennia2015Page extends ParentPage {

    public PlanPerevirkyPorushennia2015Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-violations?regulator_id=61&planning_period_id=7");
    }

...
public class ZvitPoZahodahKOza2021Page extends ParentPage {
    public ZvitPoZahodahKOza2021Page(WebDriver webDriver) {
        super(webDriver, "/report/activity?year=2021&regulator_id=103");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/report/activity?year=2021&regulator_id=103");
    }

...
public class InfoVisit2019ListPage extends ParentPage {

    public InfoVisit2019ListPage(WebDriver webDriver) {
        super(webDriver, "/inspection-info-visit/index?planning_period_id=2");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/inspection-info-visit/index?planning_period_id=2");
    }

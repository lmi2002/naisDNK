...
public class InspAllPozaplanNotAuth2017Page extends ParentPage {


    public InspAllPozaplanNotAuth2017Page(WebDriver webDriver) {
        super(webDriver, "/inspection/all-unplanned?planning_period_id=3");
    }

...
public class InspAllPozaplanNotAuthPage extends ParentPage {

    public InspAllPozaplanNotAuthPage(WebDriver webDriver) {
    ...
    @FindBy(xpath = ".//a[@href='/inspection/all-unplanned?planning_period_id=8']")
    private WebElement link2016;

    @FindBy(xpath = ".//a[@href='/inspection/all-unplanned?planning_period_id=3']")
    private WebElement link2017;

    @FindBy(xpath = ".//a[@href='/inspection/all-unplanned?planning_period_id=1']")
    private WebElement link2018;

    @FindBy(xpath = ".//a[@href='/inspection/all-unplanned?planning_period_id=2']")
    private WebElement link2019;

    @FindBy(xpath = ".//a[@href='/inspection/view?id=1804980']")

...
public class InspAllPozaplanNotAuth2019Page extends ParentPage {

    public InspAllPozaplanNotAuth2019Page(WebDriver webDriver) {
        super(webDriver, "/inspection/all-unplanned?planning_period_id=2");
    }

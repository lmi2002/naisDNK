...
public class PrevZah2019ListPage extends ParentPage {

    public PrevZah2019ListPage(WebDriver webDriver) {
        super(webDriver, "/preventive-measure/index?planning_period_id=2&tab=main");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/preventive-measure/index?planning_period_id=2&tab=main");
    }

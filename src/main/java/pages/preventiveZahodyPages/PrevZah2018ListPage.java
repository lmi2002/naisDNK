...
public class PrevZah2018ListPage extends ParentPage {


    public PrevZah2018ListPage(WebDriver webDriver) {
        super(webDriver, "/preventive-measure/index?planning_period_id=1&tab=main");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/preventive-measure/index?planning_period_id=1&tab=main");
    }

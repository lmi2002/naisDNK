...
public class RatingInspectors2020Page extends ParentPage {

    public RatingInspectors2020Page (WebDriver webDriver) {
        super(webDriver, "/regulator/rating-all?tab=tab_regulator_rating_all_2020");
    }

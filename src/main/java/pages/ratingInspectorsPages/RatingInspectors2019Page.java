...
public class RatingInspectors2019Page extends ParentPage {

    public RatingInspectors2019Page (WebDriver webDriver) {
        super(webDriver, "/regulator/rating-all?tab=tab_regulator_rating_all_2019");
    }

...
public class SearchResultUnapprovedSPOPage extends ParentPage {
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), configProperties.base_url() + "/user/index?UserSearch%5Bpib%5D=Синельник+Ірина+Анатоліївна&UserSearch%5Bemail%5D=&UserSearch%5Bsphere_id%5D=&UserSearch%5Bcreated_at%5D=&UserSearch%5BregulatorName%5D=&UserSearch%5BedsRegulatorName%5D=&tab=declined&sub=1");
    }

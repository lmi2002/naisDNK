...
public class UnapprovedEmployeesPidpOrgPage extends ParentPage {

    public UnapprovedEmployeesPidpOrgPage (WebDriver webDriver) {
        super(webDriver, "/user/index?tab=declined&sub=1");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/user/index?tab=declined&sub=1");
    }

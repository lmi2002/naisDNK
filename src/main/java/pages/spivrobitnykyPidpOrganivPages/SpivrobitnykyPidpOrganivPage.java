...
public class SpivrobitnykyPidpOrganivPage extends ParentPage {

    public SpivrobitnykyPidpOrganivPage (WebDriver webDriver) {
        super(webDriver, "/user/index?sub=1");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/user/index?sub=1");
    }

...
public class SearchResultApprovedSPOPage extends ParentPage {

    public SearchResultApprovedSPOPage (WebDriver webDriver) {
        super(webDriver, "/user/index?UserSearch%5Bpib%5D=Савчук+Інна+Мелетіївна&UserSearch%5Bemail%5D=&UserSearch%5Bsphere_id%5D=&UserSearch%5Bcreated_at%5D=&UserSearch%5BregulatorName%5D=&UserSearch%5BedsRegulatorName%5D=&tab=approved&sub=1");
    }

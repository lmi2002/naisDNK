...
import parentPage.ParentPage;
    ...
    public class PlanInsp2021Page extends ParentPage {

        public PlanInsp2021Page(WebDriver webDriver) {
            super(webDriver, "/inspection/planned?planningPeriodId=6&tab=simple");
        }
        ...
        @FindBy(xpath = ".//b[(text()) and contains(text(),'1-10')]")

...
public class PlanInsp2019Page extends ParentPage {

    public PlanInsp2019Page(WebDriver webDriver) {
        super(webDriver, "/inspection/planned?planningPeriodId=2&tab=simple");
    }

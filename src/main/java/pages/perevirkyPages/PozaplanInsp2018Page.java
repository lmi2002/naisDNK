...
public class PozaplanInsp2018Page extends ParentPage {

    public PozaplanInsp2018Page(WebDriver webDriver) {
        super(webDriver, "/inspection/unplanned?regulatorId=61&planningPeriodId=1&tab=simple");
    }
    ...
    @FindBy(xpath = ".//a[@href='/inspection/create?planning_period_id=1']")
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/inspection/unplanned?regulatorId=568&planningPeriodId=1&tab=simple");
    }

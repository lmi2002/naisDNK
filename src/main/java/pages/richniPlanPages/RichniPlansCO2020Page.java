...
public class RichniPlansCO2020Page extends ParentPage {

    public RichniPlansCO2020Page(WebDriver webDriver) {
        super(webDriver, "/regulators-plans/index?tab=tab_central_regulators_plans_2020");
    }

    @FindBy(xpath = ".//nav/div/div/div[1]/div/a/img")
    private WebElement pageLogo;

    @FindBy(xpath = ".//span[@id='select2-w2-container' and contains(text(),'За 2020 рік')]")
    ...
    @FindBy(xpath = ".//tr[2]//td[8]//a[contains(text(),'Перейти')]")
    private WebElement goToLink;

    @FindBy(xpath = ".//td[2]//a[contains(text(),'Державна служба України з питань праці')]")
    ...
    public void checkIsGoToLinkPresent() {
        Assert.assertTrue("OrganTypeItem is not displayed", isGoToLinkDisplayed());
    }

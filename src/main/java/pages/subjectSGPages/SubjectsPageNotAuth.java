...
public class SubjectsPageNotAuth extends ParentPage {

    public SubjectsPageNotAuth(WebDriver webDriver) {
        super(webDriver, "/subject/index?regulatorId=0");
    }
    ...
    @FindBy(xpath = ".//a[@href='/subject/subject/add?tab=main&regulatorId=61' ]")
    ...
    public void checkIsPageURLProdPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.gov.ua/subject/index?regulatorId=0");
    }

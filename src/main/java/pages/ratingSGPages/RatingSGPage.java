...
public class RatingSGPage extends ParentPage {
    public RatingSGPage(WebDriver webDriver) {
        super(webDriver, "/subject-rating/index?regulatorId=262");
    }
    ...
    public void checkIsAllMaxBalPresentOnFirstPosition() {
        Assert.assertTrue("All max Bal (80.00) in the grid is not displayed", isAllMaxBalDisplayed());
    }

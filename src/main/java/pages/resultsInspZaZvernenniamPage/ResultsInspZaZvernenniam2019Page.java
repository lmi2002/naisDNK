...
public class ResultsInspZaZvernenniam2019Page extends ParentPage {

    public ResultsInspZaZvernenniam2019Page (WebDriver webDriver) {
        super(webDriver, "/index?planning_period_id=2");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/index?planning_period_id=2");
    }

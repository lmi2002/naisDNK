...
public class ResultsInspZaZvernenniam2018Page extends ParentPage {

    public ResultsInspZaZvernenniam2018Page (WebDriver webDriver) {
        super(webDriver, "/index?planning_period_id=1");
    }

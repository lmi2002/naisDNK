...
public class ResultsInspZaZvernenniamPage extends ParentPage {

    public ResultsInspZaZvernenniamPage (WebDriver webDriver) {
        super(webDriver, "/inspection-complaint/index");
    }

...
public class ComplexPlanChanges2019Page extends ParentPage {

    public ComplexPlanChanges2019Page (WebDriver webDriver) {
        super(webDriver, "/complex-plan-change/index?complex_plan_id=68");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/complex-plan-change/index?complex_plan_id=68");
    }

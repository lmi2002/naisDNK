...
public class ComplexPlanChanges2020Page extends ParentPage {

    public ComplexPlanChanges2020Page (WebDriver webDriver) {
        super(webDriver, "/complex-plan-change/index?complex_plan_id=69");
    }
    ...
    @FindBy(xpath = ".//b[(text()) and contains(text(),'38')]")
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "https://inspections.test.nais.gov.ua/complex-plan-change/index?complex_plan_id=69");
    }

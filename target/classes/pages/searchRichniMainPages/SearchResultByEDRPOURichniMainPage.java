...
public class SearchResultByEDRPOURichniMainPage extends ParentPage {

    public SearchResultByEDRPOURichniMainPage (WebDriver webDriver) {
    ...
    public void checkIsCompanyNamePresent() {
        Assert.assertTrue("Searched Company is not displayed", webDriver.getPageSource().contains("ХАДО-ТЕ"));
    }

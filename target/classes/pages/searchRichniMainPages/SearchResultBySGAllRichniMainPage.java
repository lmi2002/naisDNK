...
public class SearchResultBySGAllRichniMainPage extends ParentPage {

    public SearchResultBySGAllRichniMainPage (WebDriver webDriver) {
        super(webDriver, "/site/index?AnnualInspection%5Bname%5D=ПРУЖИННИЙ&AnnualInspection%5Bregulator_id%5D=61&planning_period_id=4&tab=annual");
    }
    ...
    public void checkIsCompanyNamePresent() {
        Assert.assertTrue("Searched Company is not displayed", webDriver.getPageSource().contains("ЦЕНТР"));
    }

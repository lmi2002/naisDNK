...
public class PozaplanPerevirkyAll2016Page extends ParentPage {

    public PozaplanPerevirkyAll2016Page(WebDriver webDriver) {
        super(webDriver, "/report/unplanned-general?regulator_id=61&planning_period_id=5");
    }

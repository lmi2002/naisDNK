...
public class PozaplanPerevirkyPorushennia2016Page extends ParentPage {

    public PozaplanPerevirkyPorushennia2016Page(WebDriver webDriver) {
        super(webDriver, "/report/unplanned-violations?regulator_id=61&planning_period_id=5");
    }

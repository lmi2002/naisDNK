...
public class PozaplanPerevirkyAll2017Page extends ParentPage {

    public PozaplanPerevirkyAll2017Page(WebDriver webDriver) {
        super(webDriver, "/report/unplanned-general?regulator_id=61&planning_period_id=3");
    }

    @FindBy(xpath = ".//h1[@class='page_title' and contains(text(),'Позапланові перевірки (загальні дані)')]")
    private WebElement pageTitle;

    @FindBy(xpath = ".//div/div/div/div[4]/div/div/div[2]/div/div[2]/div[1]/div/table/thead/tr/th[6]/a")

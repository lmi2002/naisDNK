...
public class ReportStatistics2016Page extends ParentPage {

    public ReportStatistics2016Page(WebDriver webDriver) {

        super(webDriver, "/regulator/statistics?planning_period_id=8");
    }

...
public class ReportStatistics2019Page extends ParentPage {

    public ReportStatistics2019Page(WebDriver webDriver) {

        super(webDriver, "/regulator/statistics?planning_period_id=2");
    }

...
public class PlanPerevirkyAll2019Page extends ParentPage {
    ...
    public PlanPerevirkyAll2019Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-general?regulator_id=61&planning_period_id=2");
    }
    ...
    @FindBy(xpath = ".//a[@href='/report/unplanned-general?regulator_id=61&planning_period_id=2']")
    private WebElement pozaplanPerevirkyAllLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-violations?regulator_id=61&planning_period_id=2']")

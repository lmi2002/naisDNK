...
public class PlanPerevirkyAll2016Page extends ParentPage {

    public PlanPerevirkyAll2016Page(WebDriver webDriver) {
        super(webDriver, "/report/plan-general?regulator_id=61&planning_period_id=5");
    }

    @FindBy(xpath = ".//h1[@class='page_title' and contains(text(),'Планові перевірки (загальні дані)')]")
    private WebElement pageTitle;

    @FindBy(xpath = ".//th[contains(text(),'Найменування суб’єкта господарювання')]")
    private WebElement gridElement;

    @FindBy(xpath = ".//button[@id='report-search-btn' and contains(text(),'Шукати')]")
    private WebElement searchBtn;

    @FindBy(xpath = ".//a[@href='/report/plan-violations?regulator_id=61&planning_period_id=5']")
    private WebElement planPerevirkyPorushenniaLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-general?regulator_id=61&planning_period_id=5']")
    private WebElement pozaplanPerevirkyAllLink;

    @FindBy(xpath = ".//a[@href='/report/unplanned-violations?regulator_id=61&planning_period_id=5']")

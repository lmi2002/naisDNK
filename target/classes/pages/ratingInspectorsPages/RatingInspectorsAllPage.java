...
public class RatingInspectorsAllPage extends ParentPage {

    public RatingInspectorsAllPage (WebDriver webDriver) {
        super(webDriver, "/regulator/rating-all");
    }
    ...
    @Step
    public void clickOnU2022YearLink() {
        actionsWithOurElements.clickOnElement(u2022YearLink);
    }

...
public class RatingInspectors2022Page extends ParentPage {

    public RatingInspectors2022Page(WebDriver webDriver) {
        super(webDriver, "/regulator/rating-all?tab=tab_regulator_rating_all_2022");
    }

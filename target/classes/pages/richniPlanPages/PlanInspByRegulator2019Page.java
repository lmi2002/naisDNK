...
public class PlanInspByRegulator2019Page extends ParentPage {

    public PlanInspByRegulator2019Page(WebDriver webDriver) {
        super(webDriver, "/plan/annual?regulatorId=39&planningPeriodId=2");
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/plan/annual?regulatorId=39&planningPeriodId=2");
    }
    @Step
    public void clickOnCardBtn() {
        actionsWithOurElements.clickOnElement(cardBtn);
    }
}

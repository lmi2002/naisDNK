...
public class RichniPlansCO2019Page extends ParentPage {

    public RichniPlansCO2019Page(WebDriver webDriver) {
        super(webDriver, "/regulators-plans/index?tab=tab_central_regulators_plans_2019");
    }

    @FindBy(xpath = ".//nav/div/div/div[1]/div/a/img")
    private WebElement pageLogo;

    @FindBy(xpath = ".//span[@id='select2-w2-container' and contains(text(),'За 2019 рік')]")
    ...
    public void checkIsOrganNamePresent() {
        Assert.assertTrue("Regulator's name is not displayed", webDriver.getPageSource().contains("Пенсійний фонд України"));
    }
    ...
    public void checkIsPageURLPresent() {
        Assert.assertEquals(webDriver.getCurrentUrl(), "http://inspections.staging.brdo.com.ua/regulators-plans/index?tab=tab_central_regulators_plans_2019");
    }
